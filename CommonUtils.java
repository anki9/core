...
public class CommonUtils {
     ...
     * Skips text if it finds long name, to avoid situations like replacing January with Januaryuary
     *
     * @param text - String in which replacements will be made
     * @return - the text after replacements have been made
     */
     ...
     * Skips text if it finds long name, to avoid situations like replacing Monday with Mondayday
     * 
     * @param text - String in which replacements will be made
     * @return - the text after replacements have been made
     */
