...
public class Driver {
    ...
    public void waitForElementVisible(By elementBy) {
        waitForElementVisible(elementBy, Constants.FIVE_MILLISEC_WAIT);
    }
    ...
    public void waitForElementVisible(By elementBy, int timeInSeconds) {
        ...
        waitForMilliseconds(timeInSeconds);
    ...
    public WebElement getElementWithText(By elementBy, String value) {
        return getElementWithText(elementBy, value, Constants.ONE_SEC_WAIT);
    }
    ...
    public List<WebElement> getElementsWithText(By elementBy, String value) {
        return getElementsWithText(elementBy, value, Constants.ONE_SEC_WAIT);
    }
    ...
    public void getUrl(String url) {
        ...
        try {
            ...
            LOGGER.info("JSESSIONID:" + this.scenarioData.getSessionId());
    ...
    public WebElement getDisplayedElement(WebElement parentElement, By by, int timeInSeconds) {
        ...
        return getDisplayedElement(webElements, timeInSeconds);
    }
     ...
     * portions e.g. "payment-options__option-list___1Q3YE" so the text passed to this method would be
     * "payment-options__option-list"
     *
    ...
    public List<WebElement> getElementsWithClassContainingText(String text) {
        return driver.findElements(By.xpath(String.format(xpathClassLocator, text)));
    }
}